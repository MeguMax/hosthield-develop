      ...
      <div className="w-screen mx-auto flex justify-between md:justify-start flex-wrap bg-navbar-gradient items-center">
        ...
        <div className="w-9/12 sm:w-10/12 md:w-10/12 md:ml-8 md:mx-auto xl:w-11/12 xl:ml-5 2xl:mx-auto ml-2 flex justify-between space-x-2 items-center">
          <Link href="/dashboard/admin">
            <a className="text-xl text-white font-normal">
            ...
            >
              {({ open, active }) => (
                <>
                  ...
                  >
                    <Menu.Items className="absolute right-0 w-screen bg-white rounded-t-none rounded-b-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                      <div>
                        <Menu.Item>
                          {({ active }) => (
                            <>
                              ...
                              >
                                <Menu.Items className="absolute left-6 w-3/4 sm:w-2/4 origin-top-left bg-white divide-y divide-gray-200 rounded-t-none rounded-b-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                                  <div className="">
                                    <Menu.Item>
                                      {({ active }) => (
                                        <Link href="/dashboard/admin/my-profile">
                                          <a
                                            className={`${
                                              active
                                                ? "bg-site-main text-white "
                ...
                <>
                  <div>
                    <StyledMenuButton
                      ...
                      } inline-flex justify-center w-full items-center px-4 py-5 lg:p-1.55 text-xs lg:text-sm font-medium text-white bg-black rounded-md  hover:bg-opacity-10 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 relative`}
                    >
                      {profileName}
                      <ChevronDownIcon
                        className="w-5 h-5 ml-2 -mr-1 text-violet-200 hover:text-violet-100"
                  ...
                  <Transition
                    ...
                    leaveTo="transform opacity-0 scale-95"
                  >
                    <Menu.Items className="absolute right-0 w-56 origin-top-right bg-white divide-y divide-gray-200 rounded-t-none rounded-b-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                      <div className="">
                        <Menu.Item>
                          {({ active }) => (
                            <Link href="/dashboard/admin/my-profile">
