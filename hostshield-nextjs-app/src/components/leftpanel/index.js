...
export default function LeftPanel() {
  ...
  return (
    <StyledLeftPanel
      className="leftpanel min-w-min hidden md:flex md:flex-col justify-between items-center shadow-xl bg-white fixed bottom-0 lg:bottom-auto"
    ...
    >
          ...
          <StyledLi className="w-full flex justify-center text-site-dark text-opacity-75 hover:text-opacity-100 hover:text-white p-4 border-b hover:bg-site-main hover:border-transparent ">
            <Link href="/dashboard/user/create-waiver">
              <a className="flex justify-center cursor-pointer">
                <StyledAddWaiverIcon className="w-min" title="" />
                <span className="hidden">Waiver</span>
              </a>
            </Link>
          </StyledLi>
          <StyledLi className="w-full flex justify-center text-site-dark text-opacity-75 hover:text-opacity-100 hover:text-white p-4 border-b hover:bg-site-main hover:border-transparent ">
            <Link href="/dashboard/user/my-waiver">
              <a className="flex justify-center cursor-pointer">
                ...
                <span className="hidden">My Waiver</span>
              </a>
            </Link>
          </StyledLi>
          <StyledLi className="w-full flex justify-center text-site-dark text-opacity-75 hover:text-opacity-100 hover:text-white p-4 border-b hover:bg-site-main hover:border-transparent ">
      ...
      <div className="w-full">
        <ul className="leftpanel-secondary-nav">
          <StyledLi onClick={handleLogout} className="w-full flex justify-center text-site-dark text-opacity-75 hover:text-opacity-100 hover:text-white p-4 border-t hover:bg-site-main hover:border-transparent cursor-pointer">
...
`;
const StyledAddWaiverIcon = styled(AddWaiverIcon)`
  width: 1.15rem;
  height: 1.5rem;
`;
